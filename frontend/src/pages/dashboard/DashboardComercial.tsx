                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-slate-500 flex items-center gap-1 mt-0.5">
                      {cliente.computed_expiration_date 
                        ? `Vence em: ${new Date(cliente.computed_expiration_date.substring(0, 10) + 'T12:00:00').toLocaleDateString('pt-BR')}` 
                        : cliente.contract_ends_at
                          ? `Vence em: ${new Date(cliente.contract_ends_at.substring(0, 10) + 'T12:00:00').toLocaleDateString('pt-BR')}`
                          : "Sem vencimento"
                      }
                    </p>
                  </div>
