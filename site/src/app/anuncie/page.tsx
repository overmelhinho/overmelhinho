...
export default function AnunciePage() {
    ...
    return (
        <div className="min-h-screen bg-cloud-dancer font-sans selection:bg-brand-red/10">
            {/* Header / Hero */}
            <section className="relative pt-[calc(var(--spacing)*15)] md:pt-[calc(var(--spacing)*20)] pb-12 md:pb-20 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 text-center space-y-4 md:space-y-6">
                    ...
                    >
                         {/* Planos button removed */}
                        <a
                            href="https://wa.me/5554984235245?text=Ol%C3%A1%2C%20gostaria%20de%20anunciar%20no%20Vermelhinho!"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-full sm:w-auto px-10 py-5 bg-brand-red text-white border border-brand-red rounded-2xl font-black text-lg shadow-2xl shadow-red-200 hover:scale-105 active:scale-95 transition-all flex items-center justify-center space-x-3"
                        >
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                { title: "Presença Mobile", desc: "Acesse no seu celular em qualquer lugar ou momento do dia.", icon: Zap }
                            ].map((item, i) => (
                ...
                <div className="bg-gray-900 rounded-[3rem] p-12 md:p-20 text-center space-y-8 relative overflow-hidden">
                    ...
                    <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter leading-tight italic font-serif">
                     ...
                     <p className="text-gray-400 text-lg max-w-xl mx-auto">
                        Nossa equipe comercial está pronta para te ajudar a escolher a melhor estratégia para o seu tipo de negócio.
                    </p>
                    <a
                        href="https://wa.me/5554984235245?text=Ol%C3%A1%2C%20gostaria%20de%20anunciar%20no%20Vermelhinho!"
                        target="_blank"
