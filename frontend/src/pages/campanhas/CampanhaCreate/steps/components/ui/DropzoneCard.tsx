...
type Props = {
  ...
  valueUrl?: string | null;        // preview (public_url do temp ou url local)
...
export default function DropzoneCard({
  ...
  return (
    <div className={cx("rounded-2xl border p-4 shadow-sm transition", borderCls, bgCls)}>
      ...
      <div
        className={cx(
          "mt-4 grid grid-cols-1 gap-4 md:grid-cols-12",
          disabled ? "opacity-70" : ""
        )}
      >
        <div className="md:col-span-4">
          <div
            className={cx(
              "flex h-28 w-full items-center justify-center overflow-hidden rounded-2xl border border-gray-200 bg-gray-50"
            )}
          >
            {valueUrl ? (
        ...
        <div className="md:col-span-8">
          ...
          >
            ...
            <div className="mt-1 text-sm text-gray-600">
              {fileName ? fileName : "PNG, JPG ou WebP"}
            </div>
