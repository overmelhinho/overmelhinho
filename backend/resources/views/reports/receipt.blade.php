...
<head>
    ...
    <style>
        ...
        /* Cabeçalho superior */
        .header-main {
            border-bottom: 1.5pt solid #B70F0A;
            padding-bottom: 5pt;
            margin-bottom: 8pt;
        }
    ...
    <div class="receipt-container">
        ...
        <table class="data-grid">
            ...
            <tr>
                ...
                <td class="value-cell" style="color: #B70F0A; font-size: 11pt;">
                    {{ number_format($invoice->payable_amount ?? $invoice->amount, 2, ',', '.') }}</td>
                <td class="value-cell">
                    {{ $invoice->due_date ? \Carbon\Carbon::parse($invoice->due_date)->format('d/m/Y') : '---' }}</td>
            </tr>
        </table>
        ...
        <div class="legal-text">
            <strong>VALOR POR EXTENSO:</strong> <span
                style="text-transform: uppercase;">{{ $payableAmount_extenso }}</span><br>
            Recebemos a importância acima referente ao plano {{ $invoice->plan->name ?? 'Publicidade Digital' }}. Damos
            por este recibo plena e geral quitação.
        </div>
        ...
        <table width="100%" class="signature-area">
            <tr>
                ...
                <td width="10%"></td>
                <td class="sig-box">
                    <div style="border-top: 0.5pt solid #000; padding-top: 5pt;">Assinatura do Recebedor / O Vermelhinho
                    </div>
                </td>
            </tr>
        </table>
            ...
            <table width="100%" style="margin: 0; padding: 0; border: none;">
                <tr>
                    <td style="vertical-align: bottom; padding-right: 15pt; text-align: justify; border: none;">
                        Recebemos de <span
                            class="highlight">{{ $client->razao_social ?: $client->nome_fantasia }}</span> a importância
                        de <span
                            style="text-transform: uppercase; font-weight: bold;">{{ $payableAmount_extenso }}</span> em
                        <span class="highlight"> ___/___/______ </span>.
                    </td>
                    <td style="vertical-align: bottom; width: 150pt; border: none; padding-bottom: 2pt;">
                        <div
                            style="border-top: 0.5pt solid #000; text-align: center; padding-top: 2pt; font-size: 9pt;">
                            Assinatura</div>
                    </td>
                </tr>
            </table>
